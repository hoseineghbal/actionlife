      ...
      <div className="space-y-2">
        {attachments.map((att, index) => (
          <a
            ...
            className="flex items-center gap-3 p-3 bg-dark-light border border-white/10 rounded-xl hover:border-accent/50 transition-all group"
          >
            ...
            <svg className="w-5 h-5 text-gray-custom group-hover:text-accent transition-colors shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
